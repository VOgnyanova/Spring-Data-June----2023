...
import static bg.softuni.gamestoremapping.constants.Validations.EMAIL_PATTERN;
import static bg.softuni.gamestoremapping.constants.ErrorMessages.*;
import static bg.softuni.gamestoremapping.constants.Validations.EMAIL_PATTERN;
import static bg.softuni.gamestoremapping.constants.Validations.PASSWORD_PATTERN;
