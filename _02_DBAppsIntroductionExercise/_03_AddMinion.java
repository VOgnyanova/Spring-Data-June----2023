...
public class _03_AddMinion {
    ...
    private static final String TOWN_ADDED_FORMAT =
    ...
    private static final String GET_LAST_MINION =
            "select m.id from minions as m order by m.id desc limit 1";
    private static final String INSERT_INTO_MINIONS =
